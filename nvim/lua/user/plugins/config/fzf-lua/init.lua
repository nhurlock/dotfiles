...
return {
  ...
  keys = utils.lazy_maps({
    ...
    },
    {
      ...
      pickers.projects,
      'n',
      'FzfLua find projects',
    },
    {
      '<leader>hi',
      pickers.fidget,
      'n',
      'FzfLua Fidget history',
    },
    {
      '<leader>ff',
      'FzfLua files',
    ...
    },
    {
      '<leader>fF',
      function()
        require('fzf-lua.providers.files').files({ cwd = vim.fn.expand('%:h') })
      end,
      'n',
      'FzfLua find files in current directory',
    },
    {
      '<leader>fgf',
      'FzfLua git_files',
    ...
    },
    {
      ...
      'n',
      'FzfLua LSP workspace symbols',
    },
    {
      '<leader>fds',
      'FzfLua lsp_document_symbols',
      'n',
      'FzfLua LSP document symbols',
    },
    {
      '<leader>fr',
      'FzfLua lsp_references',
      'n',
      'FzfLua LSP references',
    },
    {
      '<leader>f?',
      'FzfLua lsp_finder',
    ...
    },
    {
      ...
      'n',
      'FzfLua spelling suggestions',
    },
    {
      '<leader>f.',
      'FzfLua lgrep_curbuf',
      'n',
      'FzfLua fuzzy find in current buffer',
    },
    {
      'gd',
      'FzfLua lsp_definitions jump1=true',
      'n',
      'FzfLua LSP go to definition',
    },
    {
      'gi',
      'FzfLua lsp_implementations jump1=true',
      'n',
      'FzfLua LSP go to implementation',
    },
    {
      'gt',
      'FzfLua lsp_typedefs jump1=true',
      'n',
      'FzfLua LSP go to type definition',
    },
    {
      '<leader>sl',
      function()
        require('fzf-lua').complete_line({ search = vim.api.nvim_get_current_line() })
      end,
      'n',
      'FzfLua complete line',
    },
    {
      '<C-x><C-l>',
      function()
          ...
          ['ctrl-x'] = function(selected, opts)
            local qlist = vim.tbl_filter(function(item)
              return not vim.tbl_contains(selected, function(v)
                ...
                local matched = name .. ':' .. item.lnum .. ':' .. item.col .. ': ' .. item.text
