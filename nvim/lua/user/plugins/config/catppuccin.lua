  ...
  opts = {
    ...
    color_overrides = {
      ...
      mocha = {
        ...
        green = '#8ed9a4', -- caret (brighter, more saturated green)
        teal = '#5db0a7', -- sub-alt (more saturated teal)
        sky = '#7ecdd5', -- lighter variation of bg (more blue-ish)
        sapphire = '#60afa7', -- bg (more saturated)
        blue = '#75b8d9', -- lighter bg (proper blue tone)
        lavender = '#a6c7e3', -- even lighter bg (more blue-purple)
